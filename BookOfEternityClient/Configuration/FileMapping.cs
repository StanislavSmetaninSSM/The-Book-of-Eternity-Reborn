...
public static class FileMapping
{
    public static readonly Dictionary<string, string> FieldToFile = new()
    {
        ...
        ["completeAfterlifeActorActivities"] = "game_state/meta/afterlife_entity_profiles.json",
        ["afterlifeRelationshipChanges"] = "game_state/meta/afterlife_entity_profiles.json",
        ["afterlifeRelationshipLockUpdates"] = "game_state/meta/afterlife_entity_profiles.json",
        ["afterlifeBreakthroughQuestUpdates"] = "game_state/meta/afterlife_entity_profiles.json",
        ["afterlifeActorMaskAdds"] = "game_state/meta/afterlife_entity_profiles.json",
        ["afterlifeActorMaskUpdates"] = "game_state/meta/afterlife_entity_profiles.json",
        ["afterlifeActorMaskRemovals"] = "game_state/meta/afterlife_entity_profiles.json",
        ["afterlifeActorActiveMaskChanges"] = "game_state/meta/afterlife_entity_profiles.json",
        ...
        ["afterlifeThreatsToAdd"] = "game_state/meta/afterlife_active_threats.json",
        ["afterlifeThreatsToUpdate"] = "game_state/meta/afterlife_active_threats.json",
        ["completeAfterlifeThreatActivities"] = "game_state/meta/afterlife_active_threats.json",
        ["afterlifeThreatsToRemove"] = "game_state/meta/afterlife_active_threats.json",
        ["guardianPoliticalRelationUpdates"] = "game_state/meta/chaos_sea_guardian_politics.json",
        ["guardianPoliticalProjectUpdates"] = "game_state/meta/chaos_sea_guardian_politics.json",
        ["guardianPoliticalInfluenceUpdates"] = "game_state/meta/chaos_sea_guardian_politics.json",
        ["guardianPoliticalChronicleUpdates"] = "game_state/meta/chaos_sea_guardian_politics.json",
        ["completeGuardianPoliticalProjects"] = "game_state/meta/chaos_sea_guardian_politics.json",
        ...
        ["shiningFactionChronicleUpdates"] = "game_state/meta/shining_abode_state.json",
        ["shiningFactionInfluenceUpdates"] = "game_state/meta/shining_abode_state.json",
        ["shiningFactionStrategicMemoryUpdates"] = "game_state/meta/shining_abode_state.json",
        ["shiningFactionResourceLedgerUpdates"] = "game_state/meta/shining_abode_state.json",
