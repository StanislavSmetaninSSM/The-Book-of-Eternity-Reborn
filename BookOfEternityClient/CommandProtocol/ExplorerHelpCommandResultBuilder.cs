...
internal static class ExplorerHelpCommandResultBuilder
{
    ...
    private static void AddShiningAbodeRows(UiTableBlock table)
    {
        ...
        Add(table, "/abode_residents", "/обитатели_обители", "Запросить у ГМ состав обитателей выбранной Обители");
        Add(table, "/resident_interaction", "/общение_резидента", "Поговорить с обитателем Обители или попросить раскрыть историю через форму");
        Add(table, "/resident_transfer", "/переход_резидента", "Попросить ГМ разрешить переход готового обитателя в другую Обитель или уход");
        ...
        Add(table, "/archive_consultation", "/архивная_консультация", "Консультация по свободной записи Архива у дружественного Хранителя");
        Add(table, "/archive_project_fuel", "/архивная_подпитка_проекта", "Подпитка активного проекта дружественного Хранителя записью Архива");
        ...
        Add(table, "/training", "/обучение", "Витрина обучения: наставники, скидки на духовные искусства и дорогая самостоятельная прокачка");
        ...
        Add(table, "/shining_faction_founding", "/основание_сияющей_фракции", "Основать новую сияющую фракцию через хартию, зал, службы и сторонников");
        Add(table, "/shining_faction_realignment", "/перестройка_сияющей_фракции", "Попросить ГМ разрешить переход готового обитателя между фракциями или в нейтралитет");
        Add(table, "/shining_faction_leadership", "/смена_главы_сияющей_фракции", "Попросить ГМ разрешить отречение, наследование или мятеж за главенство во фракции");
        Add(table, "/shining_native_faction_discovery", "/открытие_нативной_фракции", "Открыть нативную фракцию Сияющей Обители с подтверждением стоимости");
        Add(table, "/shining_faction_investment", "/инвестиция_в_сияющую_фракцию", "Вложиться в видимую сияющую фракцию с подтверждением стоимости");
        Add(table, "/shining_project_support", "/поддержать_сияющий_проект", "Поддержать завершённый проект видимой сияющей фракции");
        Add(table, "/shining_project_unsupport", "/снять_поддержку_сияющего_проекта", "Снять поддержку с уже поддерживаемого сияющего проекта");
        Add(table, "/shining_project_retirement", "/отправить_сияющий_проект_в_историю", "Отправить завершённый сияющий проект в историю");
        Add(table, "/shining_gates_open", "/открыть_врата_инкарнации", "Открыть Врата инкарнации и попросить ГМ показать набор благословений");
        Add(table, "/shining_gates_select", "/выбрать_благословение", "Выбрать благословение из открытого набора Врат");
        Add(table, "/shining_gates_deselect", "/снять_благословение", "Снять выбранное благословение из текущего набора Врат");
        Add(table, "/shining_gates_reroll", "/обновить_врата", "Обновить доступные благословения Врат, если у набора осталась такая возможность");
        Add(table, "/shining_incarnation_prepare", "/подготовить_новую_жизнь", "Подготовить новую жизнь с выбранными благословениями Врат");
        Add(table, "/shining_relic_forge", "/сияющая_ковка", "Ковка реликвий души: форма, свойство, усиление, стабилизация эха или возвышение редкости");
    ...
    private static void AddMortalRows(UiTableBlock table)
    {
        ...
        Add(table, "/training", "/обучение", "Учителя, доступные навыки, цена обучения в деньгах и опыте текущего уровня");
        ...
        Add(table, "/npc_trade", "/торговля_нпс", "Торговля с НПС: открыть список торговцев текущей локации и выбрать по имени");
        ...
        Add(table, "/reveal_fate", "/открыть_судьбу", "Раскрыть предстоящие кубики и базу судьбы с подтверждением траты Чернильных Перьев");
        Add(table, "/rewrite_fate", "/переписать_судьбу", "Перебросить уже раскрытую судьбу с подтверждением повышенной траты Чернильных Перьев");
        Blank(table);
    ...
    private static void AddCommonRows(UiTableBlock table)
    {
        ...
        Add(table, "/trade", "/торговля", "Открыть торговлю текущей реальности: с НПС, Хранителем или сияющей фракцией");
