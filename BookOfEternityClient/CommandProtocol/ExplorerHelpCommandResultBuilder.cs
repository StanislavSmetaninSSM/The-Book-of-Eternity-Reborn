...
internal static class ExplorerHelpCommandResultBuilder
{
    ...
    private static void AddShiningAbodeRows(UiTableBlock table)
    {
        ...
        Add(table, "/воспоминание", "/воспоминание_начать", "Воспоминание: игровой слой 4-го квеста Хранителя в линии Сарефа, роль, способности, границы сцены и прогресс; это не Врата Памяти");
