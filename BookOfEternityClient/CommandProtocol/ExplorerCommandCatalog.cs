...
public static class ExplorerCommandCatalog
{
    ...
    [
        ...
        D("soul_relics", ExplorerCommandGroup.UniversalMeta, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.UniversalMeta, ["/soul_relics", "/реликвии"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        D("afterlife_archive", ExplorerCommandGroup.UniversalMeta, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.UniversalMeta, ["/afterlife_archive", "/архив_души"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        D("archive_candidates", ExplorerCommandGroup.UniversalMeta, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.UniversalMeta, ["/archive_candidates", "/архив_кандидаты"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        ...
        D("trade", ExplorerCommandGroup.UniversalMeta, ExplorerCommandMutationMode.LocalTurn, ExplorerCommandBrowserHandlerKind.LifecycleLocalTurn, ["/trade", "/торговля"], browserStatus: ExplorerCommandMigrationStatus.MutatingParity, acceptsArguments: true),
        ...
        D("inventory", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/inv", "/inventory", "/инв", "/инвентарь"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        D("npcs", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/npc", "/npcs", "/characters", "/нпс", "/персонажи"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        ...
        D("effects", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/effects", "/эффекты"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        ...
        D("archive_consultation", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.LocalTurn, ExplorerCommandBrowserHandlerKind.LifecycleLocalTurn, ["/archive_consultation", "/архивная_консультация"], browserStatus: ExplorerCommandMigrationStatus.MutatingParity, acceptsArguments: true),
        D("archive_project_fuel", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.LocalTurn, ExplorerCommandBrowserHandlerKind.LifecycleLocalTurn, ["/archive_project_fuel", "/архивная_подпитка_проекта"], browserStatus: ExplorerCommandMigrationStatus.MutatingParity, acceptsArguments: true),
        ...
        D("shining_abode", ExplorerCommandGroup.ShiningAbode, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.ShiningAbode, ["/shining_abode", "/сияющая_обитель"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        D("shining_politics", ExplorerCommandGroup.ShiningAbode, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.ShiningAbode, ["/shining_politics", "/сияющая_политика"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        ...
        D("afterlife_profiles", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.AfterlifeCombat, ["/afterlife_profiles", "/профили_загробья"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        D("afterlife_threats", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.AfterlifeCombat, ["/afterlife_threats", "/угрозы_загробья"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        D("afterlife_chronicles", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.AfterlifeCombat, ["/afterlife_chronicles", "/хроники_посмертия"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        D("afterlife_inbox", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.LocalTurn, ExplorerCommandBrowserHandlerKind.AfterlifeCombat, ["/afterlife_inbox", "/уведомления_загробья"], browserStatus: ExplorerCommandMigrationStatus.MutatingParity, acceptsArguments: true),
        D("spiritual_conflict", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.AfterlifeCombat, ["/spiritual_conflict", "/духовный_конфликт"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        D("spiritual_combat_log", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.AfterlifeCombat, ["/spiritual_combat_log", "/журнал_духовного_боя"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity, acceptsArguments: true),
        ...
        D("spiritual_arts", ExplorerCommandGroup.AfterlifeCombatAndEntities, ExplorerCommandMutationMode.LocalTurn, ExplorerCommandBrowserHandlerKind.AfterlifeCombat, ["/spiritual_arts", "/духовные_искусства"], browserStatus: ExplorerCommandMigrationStatus.MutatingParity, acceptsArguments: true),
