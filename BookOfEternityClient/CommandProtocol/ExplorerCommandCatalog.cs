...
public static class ExplorerCommandCatalog
{
    ...
    [
        ...
        D("factions", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/factions", "/фракции"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("skills", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/skills", "/навыки"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        ...
        D("world_news", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/world_news", "/новости_мира"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("rival_threads", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/rival_threads", "/чужие_нити"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("guardian_corrections", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/guardian_corrections", "/коррективы_хранителя"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("locations", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/locations", "/локации"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("transport", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/transport", "/транспорт"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        ...
        D("combat", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/combat", "/бой"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        ...
        D("books", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/books", "/книги", "/читать"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("storage_access", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/storage_access", "/доступ_к_хранилищам"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("interactions", ExplorerCommandGroup.MortalWorld, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.MortalWorld, ["/interactions", "/взаимодействия"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        ...
        D("guardians", ExplorerCommandGroup.ChaosSea, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.ChaosSea, ["/guardians", "/хранители"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("abode_power", ExplorerCommandGroup.ChaosSea, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.ChaosSea, ["/abode_power", "/сила_обители"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("guardian_projects", ExplorerCommandGroup.ChaosSea, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.ChaosSea, ["/guardian_projects", "/проекты_хранителей"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        ...
        D("abodes", ExplorerCommandGroup.ChaosSea, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.ChaosSea, ["/abodes", "/обители"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
        D("gacha", ExplorerCommandGroup.ChaosSea, ExplorerCommandMutationMode.ReadOnly, ExplorerCommandBrowserHandlerKind.ChaosSea, ["/gacha", "/гача"], browserStatus: ExplorerCommandMigrationStatus.ReadOnlyParity),
