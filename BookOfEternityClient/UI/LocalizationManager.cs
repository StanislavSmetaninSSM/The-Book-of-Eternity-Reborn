...
public class LocalizationManager
{
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
    {
        ["ru"] = new()
        {
            ...
            ["gm_cli_launch_command_hint"] = "Эта shell-команда запускается внутри GM Bridge. Можно указать gemini, gemini --yolo --resume, copilot или любую другую локальную CLI-команду.",
            ["gm_cli_launch_command_examples"] = "Примеры: gemini --yolo --resume | copilot | claude",
        ...
        ["en"] = new()
        {
            ...
            ["gm_cli_launch_command_hint"] = "This shell command is started inside the GM Bridge session. You can use gemini, gemini --yolo --resume, copilot, or any other local CLI command.",
            ["gm_cli_launch_command_examples"] = "Examples: gemini --yolo --resume | copilot | claude",
