...
public class LocalizationManager
{
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
    {
        ["ru"] = new()
        {
            ...
            ["gm_cli_launch_command_hint"] = "Эта shell-команда запускается внутри GM Bridge. Для Codex указывайте модель и reasoning effort явно: -m gpt-5.6-terra -c model_reasoning_effort=high.",
            ["gm_cli_launch_command_examples"] = "Примеры: codex -m gpt-5.6-terra -c model_reasoning_effort=high --dangerously-bypass-approvals-and-sandbox | copilot | claude",
        ...
        ["en"] = new()
        {
            ...
            ["gm_cli_launch_command_hint"] = "This shell command is started inside the GM Bridge session. For Codex, set model and reasoning effort explicitly: -m gpt-5.6-terra -c model_reasoning_effort=high.",
            ["gm_cli_launch_command_examples"] = "Examples: codex -m gpt-5.6-terra -c model_reasoning_effort=high --dangerously-bypass-approvals-and-sandbox | copilot | claude",
