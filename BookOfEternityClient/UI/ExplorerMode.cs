...
public partial class ExplorerMode
{
        ...
        LocalUiSessionLockOwner? localUiSessionLockOwner = null)
    {
        ...
        _chaosSeaOnlyCommands = new Dictionary<string, Func<Task>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["/воспоминание"] = ShowSarefMemorySceneAsync,
            ["/воспоминание_статус"] = ShowSarefMemorySceneAsync,
            ["/воспоминание_начать"] = ShowSarefMemorySceneAsync,
            ["/воспоминание_способности"] = ShowSarefMemorySceneAsync,
            ...
            ["/журнал_духовного_боя"] = ShowSpiritualCombatLogAsync,
