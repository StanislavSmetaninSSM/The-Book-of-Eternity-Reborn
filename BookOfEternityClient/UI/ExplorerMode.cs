...
public partial class ExplorerMode
{
        ...
        LocalUiSessionLockOwner? localUiSessionLockOwner = null)
    {
        ...
        _chaosSeaOnlyCommands = BuildCommandMap(
            ...
            ("archive_consultation", ShowAfterlifeArchive),
            ("archive_project_fuel", ShowAfterlifeArchive),
            ...
            ("resident_transfer", ShowGuardians),
            ("shining_abode", ShowShiningAbodeOverview),
            ("shining_politics", ShowShiningPoliticsOverview),
            ("shining_faction_founding", ShowShiningFactionFoundingAsync),
            ("shining_faction_realignment", ShowShiningFactionRealignmentAsync),
            ("shining_faction_leadership", ShowShiningFactionLeadershipAsync),
            ("shining_native_faction_discovery", ShowShiningCoreActionsAsync),
            ("shining_faction_investment", ShowShiningCoreActionsAsync),
            ("shining_project_support", ShowShiningCoreActionsAsync),
            ("shining_project_unsupport", ShowShiningCoreActionsAsync),
            ("shining_project_retirement", ShowShiningCoreActionsAsync),
            ("shining_gates_open", ShowShiningGatesActionsAsync),
            ("shining_gates_select", ShowShiningGatesActionsAsync),
            ("shining_gates_deselect", ShowShiningGatesActionsAsync),
            ("shining_gates_reroll", ShowShiningGatesActionsAsync),
            ("shining_incarnation_prepare", ShowShiningGatesActionsAsync),
            ("shining_trade", ShowShiningTradeAndForgeAsync),
            ("shining_relic_forge", ShowShiningTradeAndForgeAsync),
        ...
        _mortalOnlyCommands = BuildCommandMap(
            ...
            ("books", ShowItemTexts),
            ("ink_feather_reveal_fate", ShowInkFeathersMenu),
            ("ink_feather_rewrite_fate", ShowInkFeathersMenu),
            ("storage_access", ShowStorageAccess),
            ("storage_item_move", ShowInventory),
            ("vehicle_item_move", ShowTransport),
