...
{private async Task ShowSystemMods()
    ...
    private Task ShowHelp()
    {
        ...
        else if (isShiningAbode)
        {
            ...
            table.AddRow("[gold1]/воспоминание[/]", "[gold1]/воспоминание_начать[/]", "[gold1]Воспоминание: игровой слой 4-го квеста Хранителя в линии Сарефа, роль, способности, границы сцены и прогресс; это не Врата Памяти[/]");
        ...
        else if (isChaosSea)
        {
            ...
            table.AddRow("[blue]/воспоминание[/]", "[blue]/воспоминание_начать[/]", "[blue]Воспоминание: игровой слой 4-го квеста Хранителя в линии Сарефа, роль, способности, границы сцены и прогресс; это не Врата Памяти[/]");
