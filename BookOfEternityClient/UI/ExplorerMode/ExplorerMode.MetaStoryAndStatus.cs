...
{private async Task ShowSystemMods()
    ...
    private Task ShowHelp()
    {
        ...
        if (isPendingShiningAbodeBootstrap)
        {
            ...
            table.AddRow("[khaki1]/shining_abode[/]", "[khaki1]/сияющая_обитель[/]", "[khaki1]Аудит только для чтения: Врата, замороженный пакет, выбранные карты и квитанции ядра (coreActionReceipts[]); обычные действия Обители недоступны[/]");
