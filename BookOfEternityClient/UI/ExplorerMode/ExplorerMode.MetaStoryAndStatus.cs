...
{private async Task ShowSystemMods()
    ...
    private Task ShowHelp()
    {
        ...
        else if (isShiningAbode)
        {
            ...
            table.AddRow("[gold1]/saref_story[/]", "[gold1]/крылья_над_бездной[/]", "[gold1]Скрытая главная линия: раскрытые фрагменты, преимущества против Сарефа и журнал их использования[/]");
        ...
        else if (isChaosSea)
        {
            ...
            table.AddRow("[blue]/saref_story[/]", "[blue]/крылья_над_бездной[/]", "[blue]Скрытая главная линия: если ты пока не знаешь, что искать, команда не раскрывает спойлеры[/]");
