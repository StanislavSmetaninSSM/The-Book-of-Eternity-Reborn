...
public partial class ExplorerMode
{
    ...
    private Task ShowSpiritualCombatHelpAsync()
    {
        ...
        var lines = new List<string>
        {
            ...
            "  • Защита бьёт давление: это самый безопасный ответ на прямой нажим. Она не ранит противника, зато стабильно предотвращает или снижает напряжение стороны игрока.",
            ...
            "  • Оковы бьют противника после рычага: сначала нужно преимущество, подготовка или решительный успех; затем оковы ограничивают будущие действия.",
