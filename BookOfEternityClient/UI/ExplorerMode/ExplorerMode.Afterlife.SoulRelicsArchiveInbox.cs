...
public partial class ExplorerMode
{
    ...
    private async Task ShowAfterlifeArchive()
    {
        ...
        while (true)
        {
            ...
            await WriteAfterlifeArchiveEntryAuditPanelsAsync(entry.ArchiveId);
    ...
    private async Task<bool> ShowAfterlifeArchiveEntryDetailByIdAsync(string archiveId)
    {
        ...
        await WriteAfterlifeArchiveEntryAuditPanelsAsync(archiveId);

        WaitForKey();
        return true;
    }

    private async Task WriteAfterlifeArchiveEntryAuditPanelsAsync(string archiveId)
    {
