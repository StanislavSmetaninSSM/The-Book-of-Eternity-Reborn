...
public sealed partial class QteSceneService
{
    ...
    [
        ...
        new("stealth_crossing", "Галерея без звука", "Дарен входит в галерею, где портреты смотрят из пыли, а сонный страж дышит за тонкой полосой света. Каждый шаг должен утонуть в тишине: один лишний шум разбудит фонарь, а чистый проход не оставит стражам нитки к кабинету."),
