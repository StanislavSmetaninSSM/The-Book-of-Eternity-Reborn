...
public sealed partial class QteSceneService
{
    ...
    [
        ...
        new("physical_pressure", "Тяжёлая решётка", "Футляр с посохом выходит из ниши, но над ним тяжёлая решётка начинает падать, давя Дарену на плечо. Ему нужно удержать железо до последнего дюйма: если оно сорвётся, грохот разнесёт тревогу по крылу."),
        ...
        new("pursuit", "Первый рывок", "За спиной Дарена распахивается зал, и стражи уже кричат во дворе, где открытое окно сужается в полоску ночи. Ему нужен точный момент для рывка: промедление отдаст погоне темп и лицо в фонарях."),
