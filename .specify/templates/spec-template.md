...
- **Source GitHub issue(s)**: [issue numbers and URLs; every implementation spec MUST be tied to a tracked issue]
...
- If the feature touches player-facing state, what happens when summary data has no canonical detail authority?
- If the feature touches console or browser UI, how are debug/API terms kept out of player-facing surfaces?
- If the feature touches GM-authored behavior in Mortal World or afterlife, which prompts/docs/examples/tests prove the GM can author the state correctly?
