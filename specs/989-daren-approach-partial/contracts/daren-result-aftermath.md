# Daren Result Aftermath Contract: Approach Manor Partial
...
Replace only the `partial` result prose string for `approach_manor_action` with a substantial Russian dark-fantasy aftermath insert.

## Required Narrative Signals

The partial result must show:

- Daren remains the active point-of-view protagonist.
- The old linden / manor wall / blind lantern gap setting remains concrete.
- Daren's choice of shadow, step timing, body control, breath, hands, or listening demonstrates competence under pressure.
- The action works enough to keep the route moving toward the wall and Mira.
- A mixed-outcome cost remains visible: broken branch, sound, trace, doubt, delay, bodily sting/wound, witness suspicion, guard attention, dog/lantern reaction, or later evidence pressure.
...
- #988 success, #990 fail, or #991-#1008 downstream result surfaces.
