...
3. If no fresh showcase exists, the client can create `TrainingRefreshRequest`.
...
3. Self-training fallback is always visible for legal already-known standard art/focus upgrades, with high multipliers.
4. New special-art unlocks are hidden or locked unless a mentor/story/Shining source exists.
5. Purchase writes receipt and deducts afterlife currencies.
