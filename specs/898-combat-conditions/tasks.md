...
- Added-line static scan excluding `specs/**` against `origin/main...HEAD`: refined scan matched one inspected false positive, `visibility is "hidden" or "gm_only" or "private" or "secret" or "concealed" or "spoiler";`. This is a hidden-visibility enum used to suppress player output, not a credential. No actionable hardcoded secret, shell execution, eval/exec, unsafe pickle, or SQL string-formatting match.
