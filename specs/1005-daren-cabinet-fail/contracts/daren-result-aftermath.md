# Contract: Daren Cabinet Lock Fail Literary Aftermath
...
- Completed siblings intentionally preserved: [#1003](https://github.com/StanislavSmetaninSSM/The-Book-of-Eternity-Reborn/issues/1003) and [#1004](https://github.com/StanislavSmetaninSSM/The-Book-of-Eternity-Reborn/issues/1004)
...
`BookOfEternityClient/Services/QteSceneService.Daren.cs` remains the sole shared C# authority for the Daren QTE showcase route. #1005 may change only the `fail` result prose for:
...
- Existing `partial` result prose for `lock_pick_action` from #1004.
...
- Show a dangerous outcome: the lock answers too loudly or imperfectly, a trace/evidence remains, and guard/house/pursuit pressure becomes concrete.
- Use concrete sensory/action detail around pins, pick/tension tool, keyhole/bronze plate, scratch/dust, breath, hands/fingers, lock click/noise, guard or corridor response, and cabinet door movement or blocked entry.
...
- Baseline focused Daren tests passed 62 / failed 0 / skipped 0 / total 62 before implementation.
- Baseline affected Daren/QTE/docs/browser C# slice passed 331 / failed 0 / skipped 0 / total 331 before implementation.
