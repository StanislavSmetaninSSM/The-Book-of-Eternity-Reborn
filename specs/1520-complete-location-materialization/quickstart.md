...
| T100 fifth rebased-candidate PreMerge fixture failure | `pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane PreMerge` | `TestResults/test-lanes/20260813-233548-336-37208-aad85407ab00477285edb0641cfc4727-premerge` | 4667 | 2 summary failures from the legacy reusable Mortal save; cancelled sibling shards logged the same fixture boundary | 0 | 0 | Complete |
| T081 reusable Mortal location archive RED | focused Integration permanent archive-integrity test | `TestResults/test-lanes/20260813-235145-085-55600-70a8f301ec8d4b719cf326ebadb01979-focused` | 0 | 1 expected missing location identity index | 0 | 0 | Complete |
| T081 reusable Mortal archive integrity GREEN | `pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane Focused -FocusedProject Integration -Filter "FullyQualifiedName~FileSystemExampleFixtureIntegrityTests"` | `TestResults/test-lanes/20260813-235905-943-52092-72cf9c3d4b8b431a8aa06666d2334862-focused` | 22 | 0 | 0 | 0 | Complete |
| T081 reusable Mortal save command coverage GREEN | `pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane Focused -FocusedProject Integration -Filter "FullyQualifiedName~MortalCommandDisplaySaveTests"` | `TestResults/test-lanes/20260813-235953-501-17612-2038f28ab5ec43a1a79cc28fec40e3da-focused` | 96 | 0 | 0 | 0 | Complete |
| T061/T081 complete browser presentation audit GREEN | `pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane Focused -FocusedProject Integration -Filter "FullyQualifiedName~BrowserCommandPresentationAuditTests"` | `TestResults/test-lanes/20260814-000451-588-41920-faa4b6d43fda44bb80652ee44963f150-focused` | 166 | 0 | 0 | 0 | Complete |
| T100 reusable-save candidate PreMerge external timing failure | `pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane PreMerge` | `TestResults/test-lanes/20260814-000802-038-8508-65fd0a91dc0540b1b8997ead1231dc24-premerge` | 2034 | 1 known `AgentConsoleLiveInputSourceTests` pending-read race; exact test passed unchanged in isolation | 0 | 0 | Complete |
| T100 reusable-save candidate PreMerge daemon-assertion failure | `pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane PreMerge` | `TestResults/test-lanes/20260814-001544-148-56956-14563e3f21f94c1f8e661e464e2c9732-premerge` | 5241 | 3 stale daemon-context expectations after the #1513 compact-template rewrite | 0 | 0 | Complete |
| T083/T087 updated daemon-context expectations GREEN | focused Integration filter for the three Mortal-location daemon-context tests | `TestResults/test-lanes/20260814-003044-341-7736-20ea6fa8385c4ee7addd2b63dec28e17-focused` | 3 | 0 | 0 | 0 | Complete |
| T083/T087 complete daemon-helper contract GREEN | `pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane Focused -FocusedProject Integration -Filter "FullyQualifiedName~GmTurnHelperContractTests"` | `TestResults/test-lanes/20260814-003127-704-29628-b8be8105c44543a891f5773a8f1f9429-focused` | 109 | 0 | 0 | 0 | Complete |
| T100 daemon-aligned candidate PreMerge console E2E assertion failure | `pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane PreMerge` | `TestResults/test-lanes/20260814-003453-508-35792-2af63a77576a434593b819251ae366d4-premerge` | 5258 | 1 stale status-screen assertion expected the internal scripted-input exception in player-facing stdout; ProcessIntegration was 490/490 | 0 | 0 | Complete |
