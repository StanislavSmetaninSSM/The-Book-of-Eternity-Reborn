...
- [ ] T154 Remove remaining prose/genre merchant inference and setting-owned bootstrap location/faction/quest mechanics; require non-empty domain-bound `structuredGmAuthority`; narrow placeholder detection to identity/title fields; decouple all NPC tests from production bootstrap.
