...
- [ ] T189 Synchronize source guards and no-update rationale, update the managed Spec Kit agent context to this feature, and run focused/broad/full verification, Release build, static parsing, clean-checkout tests, `git diff --check`, and Spec Kit analysis.
