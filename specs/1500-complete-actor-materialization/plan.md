...
**Source issues**: [#1500](https://github.com/StanislavSmetaninSSM/The-Book-of-Eternity-Reborn/issues/1500), Phase 45 follow-up [#1502](https://github.com/StanislavSmetaninSSM/The-Book-of-Eternity-Reborn/issues/1502), and save-archive dependency [#1501](https://github.com/StanislavSmetaninSSM/The-Book-of-Eternity-Reborn/issues/1501)
...
2. retain stable worker runtime/workspace/session authority for the workspace
   ...
   replacement;
3. retain each validated single-link load-staging handle until one private
   transaction-owned guard link is opened outside the moving subtree, retain
   that exact two-link identity-plus-digest authority through the Windows
   directory move, overlap it with the published handle, delete the guard
   through opened authority, and prove the published leaf is single-link again
