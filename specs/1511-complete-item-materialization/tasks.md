...
- [ ] T013 [P] [US1] Add red bootstrap index-shape assertions in `BookOfEternityClient.IntegrationTests/MortalBootstrapValidationTests.cs` and create `BookOfEternityClient.IntegrationTests/PendingTurnSnapshotTests.cs` with red snapshot-registration coverage for the item index and governed carriers
