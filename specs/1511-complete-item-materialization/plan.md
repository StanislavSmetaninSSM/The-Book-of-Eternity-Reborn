...
pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane Focused -FocusedProject Integration -Filter "FullyQualifiedName~QuestRewardAuthorityValidationTests|FullyQualifiedName~NpcTradeRequestValidationTests"
pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane Focused -FocusedProject Integration -Filter "FullyQualifiedName~ExplorerModeCommandTests"
pwsh -NoProfile -File .\scripts\test-csharp.ps1 -Lane Focused -FocusedProject Integration -Filter "FullyQualifiedName~ExplorerWebCommandServiceTests.ExecuteAsync_Inventory|FullyQualifiedName~ExplorerWebCommandServiceTests.SubmitPromptSessionAsync_Inventory|FullyQualifiedName~ExplorerWebCommandServiceTests.ExecuteAsync_Books|FullyQualifiedName~ExplorerWebCommandServiceTests.ExecuteAsync_NpcDetail|FullyQualifiedName~ExplorerWebCommandServiceTests.ExecuteAsync_Quest|FullyQualifiedName~ExplorerWebCommandServiceTests.ExecuteAsync_PlayerInteractionRecordDetail|FullyQualifiedName~ExplorerWebCommandServiceTests.ExecuteAsync_EffectDetail|FullyQualifiedName~ExplorerWebCommandServiceTests.ExecuteAsync_StorageAndVehicleMovePrompts"
