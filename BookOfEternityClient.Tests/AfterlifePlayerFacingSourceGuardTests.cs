...
public sealed class AfterlifePlayerFacingSourceGuardTests
{
    ...
    public void ChaosSeaBlockersHelpAndLocalAuditsStayExplicit()
    {
        ...
        Assert.Contains("string.Equals(command, \"/guardians\"", explorerPrivate, StringComparison.Ordinal);
        Assert.Contains("string.Equals(command, \"/хранители\"", explorerPrivate, StringComparison.Ordinal);
        Assert.Contains("string.Equals(command, \"/abode_offering\"", explorerPrivate, StringComparison.Ordinal);
        Assert.Contains("string.Equals(command, \"/guardian_projects\"", explorerPrivate, StringComparison.Ordinal);
