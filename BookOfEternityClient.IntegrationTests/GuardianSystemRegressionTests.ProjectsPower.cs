...
{
    [Fact]
    public async Task ValidateGameState_EmptyGuardianProjectTrackerWithoutPreTurnBaselineDoesNotPoisonIdleValidation()
    {
          ...
          "guardians": [
            {
              ...
              "manifestation": {
                ...
                "appearanceDescription": "Stable guardian baseline."
              },
        ...
        var issues = await validator.ValidateGameStateAsync(GuardianValidationProfiles.ProjectsPowerState);
    ...
    public async Task GuardianPowerJournalValidation_RejectsInvalidJournalSemantics()
    {
        ...
        var validator = new ValidationService(_fs, NullLogger<ValidationService>.Instance);
        var issues = await validator.ValidateGameStateAsync(GuardianValidationProfiles.ProjectsPowerEvents);
    ...
    public async Task GuardianCommandValidation_StaleButHashValidPreTurnGuardianSnapshotDoesNotAuthorizeUnknownGuardian()
    {
        ...
        var validator = new ValidationService(_fs, NullLogger<ValidationService>.Instance);
        var issues = await validator.ValidateGameStateAsync(GuardianValidationProfiles.ProjectsPowerAuthority);
    ...
    public async Task ValidationRepairReady_DiagnosticOnlyRepairRequestFailsClosedWithDedicatedIssue()
    {
        ...
        var validator = new ValidationService(_fs, NullLogger<ValidationService>.Instance);
        var issues = await validator.ValidateGameStateAsync(GuardianValidationProfiles.ProjectsPower);
